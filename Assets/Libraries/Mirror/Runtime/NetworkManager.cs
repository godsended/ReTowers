...
#pragma warning restore 618
        ...
        protected virtual void OnServerConnect(NetworkConnectionToClient conn) {}
        ...
        protected virtual void OnServerReady(NetworkConnectionToClient conn)
        {
            if (conn.identity == null)
            {
        ...
        protected virtual void OnServerError(NetworkConnectionToClient conn, Exception exception) {}
        ...
        protected virtual void OnClientConnect(NetworkConnection conn) => OnClientConnect();
        ...
        // Deprecated 2021-12-11
        [Obsolete("Remove the NetworkConnection parameter in your override and use NetworkClient.connection instead.")]
        protected virtual void OnClientDisconnect(NetworkConnection conn) => OnClientDisconnect();
        ...
        protected virtual void OnClientNotReady() {}
        ...
        protected virtual void OnClientSceneChanged()
        {
            // always become ready.
        ...
        // Deprecated 2021-12-11
        [Obsolete("Remove the NetworkConnection parameter in your override and use NetworkClient.connection instead.")]
        protected virtual void OnClientSceneChanged(NetworkConnection conn) => OnClientSceneChanged();
