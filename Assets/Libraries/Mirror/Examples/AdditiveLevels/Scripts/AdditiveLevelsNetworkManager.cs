...
namespace Mirror.Examples.AdditiveLevels
{
    ...
    public class AdditiveLevelsNetworkManager : NetworkManager
    {
        ...
        protected override void OnServerSceneChanged(string sceneName)
        {
        ...
        protected override void OnClientChangeScene(string sceneName, SceneOperation sceneOperation, bool customHandling)
        {
        ...
        protected override void OnClientSceneChanged()
        {
        ...
        protected override void OnServerReady(NetworkConnectionToClient conn)
        {
